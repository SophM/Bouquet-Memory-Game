...
import Background from "../images/test-test.jpg";

function Jumbotron() {
    return (
        <div className="jumbotron jumbotron-fluid mb-0 pb-4" style={{backgroundImage: "url(" + Background + ")", backgroundSize: "cover", backgroundPosition: "bottom"}}>
